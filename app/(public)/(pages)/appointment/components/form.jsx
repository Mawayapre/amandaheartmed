...
const Form = () => {
  ...
  const formattedTime = selectedSlot ? selectedSlot : 'Not selected';
      ...
      <div className={styles.wrapper}>
        <div className={styles.successCard}>
          ...
          <div className={styles.summaryGrid}>
            ...
            <div className={styles.summaryRow}>
              <span>Date</span>
              <span>{formattedDate || 'Not selected'}</span>
            </div>
            <div className={styles.summaryRow}>
              <span>Time</span>
          ...
          <button className={styles.btnNext} onClick={resetForm}>
            Book Another
          </button>
        </div>
      </div>
            ...
            <div className={styles.formGrid}>
              <div className={styles.formField}>
                ...
                <input
                  ...
                  onChange={updatePatient('firstName')}
                />
              </div>
              <div className={styles.formField}>
                ...
                <input
                  ...
                  onChange={updatePatient('lastName')}
                />
              </div>
              <div className={styles.formField}>
